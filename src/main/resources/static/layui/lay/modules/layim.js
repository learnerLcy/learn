...
layui.define(["layer", "laytpl", "upload"], function (i) {
    ...
    var u = function (i) {
            ...
            ", function(i, data){ length++; }}", '<li layim-event="chat" data-username="{{data.id}}" data-type="' + i.type + '" data-index="{{data.id}},{{ ' + (i.index ||
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        A = function () {
            x.parent().on("contextmenu", function (i) {
        ...
        T = function (i) {
            return b && t.close(b.attr("times")), x && x.hide(), j.mine = j.mine || {}, t.open({
                ...
                offset: "rb",
                resize: !1,
                content: '<img src="' + (j.mine.avatar || layui.cache.dir + "css/modules/layim/skin/logo.jpg") + '"><span>' + (i ||
        ...
        ti = {
            ...
            menuHistory: function (i, a) {
                ...
                if ("one" === s) {
                    ...
                    delete r[l.data("index")], n.history = r, layui.data("layim", {
                        key: j.mine.id,
                        value: n
                    }), e(o.find(".layim-" + id).remove()), 0 === o.find("li").length && o.html(d)
            ...
            menuInviteToGroup: function (i, a) {
                var n = layui.data("layim")[j.mine.id] || {},
                    l = i.parent(),
                    s = i.data("type"),
                    o = x.find(".layim-list-history"),
            ...
            menuKickOutMember: function (i, a) {
                var n = layui.data("layim")[j.mine.id] || {},
                    l = i.parent(),
                    s = i.data("type"),
                    o = x.find(".layim-list-history"),
            ...
            menuCreateGroup: function (i, a) {
                var n = layui.data("layim")[j.mine.id] || {},
                    l = i.parent(),
                    s = i.data("type"),
                    o = x.find(".layim-list-history"),
                    d = '<li class="layim-null">暂无历史会话</li>';
                var username = [j.mine.id];

                var index = layer.open({
                    type: 2,
                    title: '创建群组',
                    content: '/op/createGroupPage'  ,
                    maxmin: true,
                    shade: 0,
                    area: ['400px','300px'],
                    success: function (layero, index) {
